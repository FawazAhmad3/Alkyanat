    ...
    <div className={`min-h-screen bg-brand-navy-dark text-slate-300 flex flex-col justify-between font-sans overflow-x-hidden ${isRtl ? 'text-right' : 'text-left'}`} dir={isRtl ? 'rtl' : 'ltr'}>
      ...
      <main className="flex-grow pt-[88px] relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
              ...
              <div className="lg:col-span-5 flex flex-col space-y-8">
                <div className="space-y-4">
                  <span className="inline-flex items-center text-xs font-bold uppercase tracking-widest text-brand-blue bg-white/[0.02] border border-white/[0.08] px-3.5 py-1.5 rounded-full w-fit font-display">
                    {data.info.subtitle}
                  </span>
                ...
                <div className="space-y-5">
                  {/* Address Card */}
                  <div className="flex gap-4 p-5 bg-white/[0.02] border border-white/[0.06] rounded-2xl hover:border-brand-blue/30 hover:bg-white/[0.03] hover:shadow-xl hover:shadow-brand-blue/5 transition-all duration-300 group">
                    <div className="p-3 bg-white/[0.02] border border-white/[0.08] text-brand-blue rounded-xl h-11 w-11 shrink-0 flex items-center justify-center shadow-md group-hover:bg-brand-blue group-hover:text-brand-navy transition-all duration-300">
                      <MapPin className="h-5 w-5" />
                    </div>
                    <div className="flex flex-col">
                      <span className="text-[9px] uppercase tracking-wider font-extrabold text-slate-550">
                        {data.info.addressLabel}
                      </span>
                      <span className="text-xs md:text-sm text-white font-bold mt-1.5 leading-normal font-sans">
                        {data.info.address}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-4 p-5 bg-white/[0.02] border border-white/[0.06] rounded-2xl hover:border-brand-blue/30 hover:bg-white/[0.03] hover:shadow-xl hover:shadow-brand-blue/5 transition-all duration-300 group">
                    ...
                    <div className="flex flex-col">
                      ...
                      <a 
                        ...
                        className="text-xs md:text-sm text-white font-extrabold hover:text-brand-blue mt-1.5 transition-colors font-sans"
                      >
                        {data.info.phone}
                      </a>
                    </div>
                  ...
                  {/* WhatsApp Card */}
                  <div className="flex gap-4 p-5 bg-white/[0.02] border border-white/[0.06] rounded-2xl hover:border-emerald-500/30 hover:bg-white/[0.03] hover:shadow-xl hover:shadow-emerald-500/5 transition-all duration-300 group">
                    <div className="p-3 bg-emerald-950 text-emerald-400 rounded-xl h-11 w-11 shrink-0 flex items-center justify-center shadow-md group-hover:bg-emerald-500 group-hover:text-brand-navy transition-all duration-300">
                    ...
                    <div className="flex flex-col">
                      ...
                      <a 
                        ...
                        className="text-xs md:text-sm text-white font-extrabold hover:text-emerald-400 mt-1.5 transition-colors font-sans"
                      >
              ...
              <div className="lg:col-span-7 bg-white/[0.02] border border-white/[0.06] rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
                <div className="absolute -right-20 -bottom-20 w-64 h-64 bg-brand-blue/5 rounded-full blur-3xl pointer-events-none" />
                
                <div className="mb-8 space-y-3">
                  <span className="text-xs font-bold uppercase tracking-widest text-brand-blue font-display">
                    {data.form.subtitle}
                  </span>
                  <h3 className="text-xl md:text-3xl font-extrabold text-white tracking-tight font-display">
                    {data.form.title}
                  </h3>
                </div>
                ...
                {isSubmitted ? (
                  <div className="flex flex-col items-center justify-center text-center py-10 space-y-4">
                    ...
                    <button
                      onClick={handleReset}
                      className="px-6 py-3 bg-white/[0.02] border border-white/[0.08] hover:border-brand-blue text-white hover:text-brand-blue font-bold text-xs uppercase tracking-wider rounded-xl transition-all cursor-pointer shadow-md font-display"
                    >
                      {data.form.reset}
                    </button>
                  </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="text-[10px] uppercase tracking-wider font-bold text-slate-400 font-display">
                          {data.form.nameLabel}
                        </label>
                        <input
                          required
                          ...
                          className="px-4 py-3.5 bg-white/[0.01] border border-white/[0.08] focus:border-brand-blue rounded-xl focus:outline-none text-xs font-semibold text-white placeholder-slate-500"
                        />
                      </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                      ...
                      <div className="flex flex-col gap-1.5">
                        ...
                        <select
                          ...
                          value={formData.type}
                          onChange={handleInputChange}
                          className="px-4 py-3.5 bg-white/[0.02] border border-white/[0.08] focus:border-brand-blue rounded-xl focus:outline-none text-xs font-semibold text-slate-300 cursor-pointer"
                        >
                    ...
                    <div className="flex flex-col gap-1.5">
                      ...
                      <textarea
                        ...
                        className="px-4 py-3.5 bg-white/[0.01] border border-white/[0.08] focus:border-brand-blue rounded-xl focus:outline-none text-xs font-semibold text-white placeholder-slate-500 resize-none"
                      />
                    </div>

                    <button
                      type="submit"
                      className="w-full py-4 px-6 bg-brand-blue hover:bg-brand-blue-hover text-brand-navy font-extrabold uppercase tracking-wider text-xs rounded-xl shadow-lg shadow-brand-blue/15 hover:shadow-brand-blue/30 transition-all flex items-center justify-center gap-2 cursor-pointer group font-display"
                    >
        ...
        <section className="pb-24 bg-transparent">
          <div className="max-w-7xl mx-auto px-6">
            <div className="bg-white/[0.02] border border-white/[0.06] rounded-3xl p-4 md:p-6 shadow-2xl overflow-hidden relative group">
              {/* Decorative background grid */}
              <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff_1px,transparent_1px),linear-gradient(to_bottom,#ffffff_1px,transparent_1px)] bg-[size:2rem_2rem] opacity-[0.02] pointer-events-none" />
              
              <div className="relative w-full h-80 rounded-2xl overflow-hidden border border-white/[0.08] bg-slate-950/40 flex flex-col items-center justify-center text-center p-6 space-y-4">
                <div className="p-4 bg-white/[0.02] border border-white/[0.08] text-brand-blue rounded-full shadow-lg z-10 animate-pulse">
                  <MapPin className="h-8 w-8" />
                </div>
                <div className="z-10 max-w-md">
                  <h4 className="text-lg font-extrabold text-white tracking-tight font-display">
                    {data.info.mapTitle}
                  </h4>
                  <p className="text-xs text-slate-400 font-semibold mt-2 leading-relaxed">
                    {data.info.address}
                  </p>
                  <p className="text-[10px] text-brand-blue font-bold uppercase tracking-widest mt-4 font-display">
                    {data.info.mapAddress}
                  </p>
                </div>
                {/* Styled map background graphics (mockup) */}
                <div className="absolute inset-0 opacity-[0.04] pointer-events-none flex items-center justify-center">
                  <svg viewBox="0 0 800 400" className="w-full h-full stroke-white stroke-[2.5] fill-none">
                    ...
                    <circle cx="500" cy="250" r="60" className="fill-brand-indigo/10" />
                  </svg>
                </div>
              </div>
            </div>
